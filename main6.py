...
# Se a variável 'Escolaridade após 2005' for categórica, você pode precisar codificá-la
# Supondo que seja numérica ou já convertida
# Caso contrário, use uma das abordagens de codificação.
